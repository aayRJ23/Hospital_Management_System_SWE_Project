...
const userZodSchema = z.object({
  ...
  role: z.enum(["Admin", "Patient", "Doctor"], "Role must be 'Admin', 'Patient', or 'Doctor'"),
  ...
  avatar: z
    ...
    .optional(),
  doctorConsultationFee: z.number().nonnegative("Consultation Fee must be greater than or equal to 0").optional(),
});
