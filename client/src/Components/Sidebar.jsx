...
const Sidebar = () => {
  ...
  return (
    <div className={`fixed h-screen ${isOpen ? 'w-48' : 'w-16'} transition-all duration-300 bg-[#FA7070] border-r-2 border-gray-600`}>
      <div className="flex flex-col items-center py-7">
        ...
        {isOpen && (
          <div className="mt-4 flex flex-col items-start pl-2 space-y-4">
            ...
            <button 
              onClick={() => navigateAndKeepOpen("/inventory")} 
              className={`mb-4 px-4 py-2 w-full text-left font-bold hover:bg-gray-300 transition-colors duration-200 ${location.pathname === "/inventory" ? "border border-gray-100 bg-gray-200 rounded-full" : ""}`}>
              Inventory
            </button>
            <button 
              onClick={() => navigateAndKeepOpen("/billing")} 
              className={`mb-4 px-4 py-2 w-full text-left font-bold hover:bg-gray-300 transition-colors duration-200 ${location.pathname === "/billing" ? "border border-gray-100 bg-gray-200 rounded-full" : ""}`}>
              Billing
            </button>
            <button 
