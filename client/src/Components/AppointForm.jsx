...
const AppointForm = ({ data, onClose }) => {
  ...
  const handleAppointment = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8000/api/v1/appointments/post",
        {
          firstName,
          lastName,
          email,
  ...
  return (
    <div className="z-50 fixed inset-0 bg-opacity-30 backdrop-blur-sm flex justify-center items-center overflow-y-auto">
