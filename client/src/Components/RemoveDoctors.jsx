...
const RemoveDoctors = ({ data }) => {
  ...
  return (
    <div
      key={data._id}
      className="flex w-full bg-white box-border h-fit  rounded-3xl py-4 px-10 border-4 shadow-[0_24px_40px_-15px_rgba(0,0,0,0.3)] items-center justify-between ml-14 mb-10"
    >
