...
const AddDoctor = () => {
  ...
  const handleAddNewDoctor = async (e) => {
    ...
    try {
      ...
      formData.append("doctorConsultationFee", doctorConsultationFee);
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center mb-4">
                    <div className="flex items-center w-1/2 pr-2">
                      ...
                      <select
                        className="w-2/3 h-10 bg-zinc-200 rounded-2xl px-4 border border-black"
                    ...
                    <div className="flex items-center w-1/2 pl-2">
                      ...
                      <input
                        className=" ml-10 w-2/3 h-10 bg-zinc-200 rounded-2xl px-4 border border-black"
                        type="number"
