...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* Departments section */}
      <div className="sec-2 w-full h-fit p-10 bg-gradient-to-t from-[#fa7070] to=[#e36d6d] animate-fade-in">
      ...
      <div className="sec-3 w-full h-fit bg-gradient-to-b from-[#fa7070] to-[#a0c4ff] pb-10 px-4 animate-fade-in">
        <div className="department-head flex justify-center mb-5">
          <h1 className="text-4xl font-semibold text-[#333]">
            Send Us A Message
          </h1>
