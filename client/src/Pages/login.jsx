...
const Login = () => {
  ...
  return (
    <motion.div
      className="flex flex-col lg:flex-row min-h-screen bg-gradient-to-r from-green-500 to-teal-500"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="lg:w-1/2 flex flex-col justify-center items-center bg-white bg-opacity-30 backdrop-blur-lg p-10 rounded-br-full shadow-xl">
        ...
        <button
          className="w-40 py-2 rounded-2xl font-semibold border-2 border-white text-white hover:bg-white hover:text-green-500 transition duration-300"
          onClick={goToRegister}
        >
          Sign Up
        </button>
        <button
          className="w-44 mt-5 py-2 rounded-2xl font-semibold border-2 border-white text-white hover:bg-white hover:text-green-500 transition duration-300"
          onClick={goToHome}
        >
          Home
        </button>
      ...
      <div className="lg:w-1/2 flex flex-col justify-center items-center bg-white bg-opacity-20 backdrop-blur-lg p-10 shadow-xl mt-10 lg:mt-0 lg:rounded-tl-full">
        ...
        >
          ...
          <motion.button
            className="w-40 bg-green-600 rounded-2xl h-10 text-white font-semibold shadow-lg hover:bg-green-700 transition duration-300"
            type="submit"
